...
* [**rmdja**](https://github.com/Gedevan-Aleksizde/rmdja) パッケージのマニュアル (実際には雑多な技術メモ, 上記どれにも書かれていない問題ならヒントが載っているかもしれません) 
...
[https://github.com/Gedevan-Aleksizde/tokyor-91-rmd](https://github.com/Gedevan-Aleksizde/tokyor-91-rmd) (Rpubs の仕様なのか移動できないことがあります. URL をコピーペーストしてみてください.)
