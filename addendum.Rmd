...
```{r, ggplot-example, fig.cap ="ggplot2 によるグラフ", warning=F}
data(mtcars)
ggplot(mtcars, aes(x = mpg, y = disp, color = cyl)) +
  geom_point() + labs(x = "マイル/ガロン", y = "排気量")
```
...
```{r plot-example, fig.cap = "標準正規分布", warning=F}
...
```{r, results="asis", reftitle, echo=F, eval=!knitr::is_latex_output() & !knitr::is_html_output()}
