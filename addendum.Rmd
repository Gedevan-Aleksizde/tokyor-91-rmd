...
* 高橋康介『[再現可能性のすゝめ](https://www.kyoritsu-pub.co.jp/bookdetail/9784320112438){target="_blank"}』

より発展的な多くの問題は, 以下を読むことで解決できます.

* 『[R Markdown クックブック](https://gedevan-aleksizde.github.io/rmarkdown-cookbook/){target="_blank"}』 (翻訳版を作成しました)
* "[_R Markdown: The Definitive Guide_](https://bookdown.org/yihui/rmarkdown/markdown-syntax.html){target="_blank"}" (英語)
* "[_bookdown: Authoring Books and Technical Documents with R Markdown_](https://bookdown.org/yihui/bookdown/){target="_blank"}" (英語)
